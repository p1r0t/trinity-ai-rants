-- Add 50+ diverse news sources from around the world
...
('Reddit Technology', 'tech', 'https://www.reddit.com/r/technology', true),
('Medium Technology', 'tech', 'https://medium.com/topic/technology', true),
